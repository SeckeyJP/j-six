...
**Version 2.0** | 2026-04-18 | Author: H.Sekita
...
| テストカバレッジ | 60-70% | 85-95% | **15-25pt向上**（※3） | 🟢 実測例あり（※6） |
...
| P3: タスク分解 | ◎参照 | | | | TaskCreated Hook | Native Tasks |
| P4: TDD 実装 | ◎参照 | TDD Skill | Red/Green/Refactor | 並列実行 | 品質チェック, PermissionDenied | git worktree, /effort, Remote Control |
| P5: 品質検証 | ◎参照 | 品質メトリクス | | /ultrareview | 品質ゲート判定, StopFailure | Push Notifications |
