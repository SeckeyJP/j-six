...
>
> 上表はケーススタディ #1 / #2 の時点の値。その後 [Plugin 実動検証 #1](../../docs/plugin-field-test-01.md)（2026-09-19）で
> TASK-AW-002（エラーの分類、全状態遷移でのコメント記録）を実装し、現在の値はテスト 81 件＋hold-out 受入 72 件、
> カバレッジ 99.0%、mutation score 92.42%（198 ミュータント中 183 killed）、トレーサビリティ 21/21（REQ 12 + PROP 9）。
